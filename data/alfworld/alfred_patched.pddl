...
(define (domain alfred)
 ...
 (:constants
  SinkBasinType SinkType MicrowaveType FridgeType - rtype
  ButterKnifeType KnifeType - otype
 )
 ...
 (:predicates
    ...
    (objectAtLocation ?o - physical-object ?l - location)              ; true if the object is at the location
    (openable ?r - receptacle)                                ; true if a receptacle is openable
    (opened ?r - receptacle)                                  ; true if a receptacle is opened
    (inReceptacle ?o - physical-object ?r - receptacle)                ; object ?o is in receptacle ?r
    (isReceptacleObject ?o - physical-object)                          ; true if the object can have things put inside it
    (inReceptacleObject ?innerObject - physical-object ?outerObject - physical-object)                ; object ?innerObject is inside object ?outerObject
    (isReceptacleObjectFull ?o - physical-object)                      ; true if the receptacle object contains something
    (wasInReceptacle ?o - physical-object ?r - receptacle)             ; object ?o was or is in receptacle ?r now or some time in the past
    ...
    (objectType ?o - physical-object ?t - otype)                       ; the type of object (Apple vs Apple|01|2...)
    (holds ?a - agent ?o - physical-object)                            ; object ?o is held by agent ?a
    ...
    (isToggled ?o - physical-object)                                   ; true if the object has been toggled
    (sliceable ?o - physical-object)                                   ; true if the object can be sliced
    (isSliced ?o - physical-object)                                    ; true if the object is sliced
 )
...
(:action examineObject
    :parameters (?a - agent ?o - physical-object)
    :precondition
        (or
            ;(exists (?l - location)
            ;    (and
...
;; agent puts down an object
 (:action PutObject
    :parameters (?a - agent ?l - location ?o - physical-object ?r - receptacle ?ot - otype ?rt - rtype)
    :precondition (and
            (holds ?a ?o)
            (atLocation ?a ?l)
            (receptacleAtLocation ?r ?l)
...
;    :parameters (?a - agent ?l - location ?ot - otype ?o - physical-object ?outerO - physical-object ?outerR - receptacle)
;    :precondition (and
;            (atLocation ?a ?l)
...
;    :parameters (?a - agent ?l - location ?ot - otype ?o - physical-object ?r - receptacle)
;    :precondition (and
;            (atLocation ?a ?l)
;            (receptacleAtLocation ?r ?l)
;            (or (not (openable ?r)) (opened ?r))    ; receptacle is opened if it is openable
...
;    :parameters (?a - agent ?l - location ?ot - otype ?innerO - physical-object ?outerO - physical-object ?r - receptacle) ; ?rt - rtype)
;    :precondition (and
;            (atLocation ?a ?l)
;            (receptacleAtLocation ?r ?l)
...
;; agent slices some object with a knife
 (:action SliceObject
    :parameters (?a - agent ?l - location ?co - physical-object ?ko - physical-object)
    :precondition
            (and
                (sliceable ?co)
                (or
